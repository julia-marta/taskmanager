...
render(header, createMenuMarkup(), `beforeend`);
render(mainPage, createFilterMarkup(), `beforeend`);
render(mainPage, createBoardMarkup(), `beforeend`);
...
render(taskList, createCardEditMarkup(), `beforeend`);

for (let i = 0; i < CARD_COUNT; i++) {
  render(taskList, createCardMarkup(), `beforeend`);
}

render(board, createLoadButtonMarkup(), `beforeend`);
